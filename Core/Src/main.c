...
uint32_t sine_val[100];
 ...
 /*
  * Function for getting the sine values for the signal.
  */
void get_sineval ()
{
...
{
  /* USER CODE BEGIN 1 */
//	double *SineWaveTable;
//	SineWaveTable = sine_wave_gen();
...
//	  HAL_Delay(500);
	...
	//  LED_State = HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_13);

//	  HAL_DAC_SetValue(&hdac, DAC_CHANNEL_1, DAC_ALIGN_8B_R, dac_value);
//	  DAC_State = HAL_DAC_GetValue(&hdac, DAC_CHANNEL_1);
//	  HAL_Delay(500);
//	  HAL_DAC_SetValue(&hdac, DAC_CHANNEL_1, DAC_ALIGN_8B_R, 500);
//	  DAC_State = HAL_DAC_GetValue(&hdac, DAC_CHANNEL_1);
//	  HAL_Delay(500);
